...
/**
 * Created by heifrank on 16/4/16.
 */
...
public class AvroSchemaEvolution {
    ...
    public void serialize() throws JsonParseException, JsonProcessingException, IOException {
        ...
        InputStream in = new FileInputStream("/Users/heifrank/IdeaProjects/my_test_project/zzzzzzz/src/main/resources/StudentActivity.json");

        // create a schema
        Schema schema = new Schema.Parser().parse(new File("/Users/heifrank/IdeaProjects/my_test_project/zzzzzzz/src/main/resources/StudentActivity.avsc"));
        ...
        File AvroFile = new File("/Users/heifrank/IdeaProjects/my_test_project/zzzzzzz/src/main/resources/StudentActivity.avro");
    ...
    public void deserialize () throws IOException {
        // create a schema
        Schema schema = new Schema.Parser().parse(new File("/Users/heifrank/IdeaProjects/my_test_project/zzzzzzz/src/main/resources/StudentActivityNew.avsc"));
